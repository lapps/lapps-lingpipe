 ...
 * @author Di Wang.
 */
public class LingpipeTokenizerTest {

    protected WebService service;

    @Before
    public void setUp() {
        service = new LingpipeTokenizer();
    }
    ...
    public void testGetMetadata() throws Exception {
        ...
        assertEquals("Name is not correct", LingpipeTokenizer.class.getName(), metadata.getName());
    ...
    public void testExecute() throws Exception {
        ...
        assertEquals("Token 1: wrong type", Uri.TOKEN, ne1.getAtType());
        assertEquals("Token 1: wrong start", 0L, ne1.getStart().longValue());
        assertEquals("Token 1: wrong word", "Barack", ne1.getFeature(Features.Token.WORD));

        Annotation ne2 = annotations.get(9);
        assertEquals("Token 2: wrong end", 55L, ne2.getEnd().longValue());
        assertEquals("Token 2: wrong word", "States", ne2.getFeature(Features.Token.WORD));
    }
