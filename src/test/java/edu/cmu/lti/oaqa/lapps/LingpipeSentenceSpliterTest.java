 ...
 * @author Di Wang.
 */
public class LingpipeSentenceSpliterTest {

    protected WebService service;

    @Before
    public void setUp() {
        service = new LingpipeSentenceSpliter();
    }
    ...
    public void testGetMetadata() throws Exception {
        ...
        assertEquals("Name is not correct", LingpipeSentenceSpliter.class.getName(), metadata.getName());
    ...
    public void testExecute() throws Exception {
        ...
        assertEquals("Token 1: wrong label", Uri.SENTENCE, ne1.getLabel());
