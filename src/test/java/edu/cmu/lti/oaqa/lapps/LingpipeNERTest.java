...
public class LingpipeNERTest {
    ...
    public void testExecute() throws Exception {
		...
		assertEquals("Token 1: wrong category", "PERSON", ne1.getFeature(Features.NamedEntity.CATEGORY));
        ...
        assertEquals("Token 2: wrong type", Uri.NE, ne2.getAtType());
//		assertEquals("Token 2: wrong category", "LOCATION", ne1.getFeature(Features.NamedEntity.CATEGORY));
